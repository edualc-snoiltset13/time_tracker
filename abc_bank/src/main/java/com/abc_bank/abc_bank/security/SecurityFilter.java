...
import com.abc_bank.abc_bank.exceptions.CustomAccessDenialHandler;
...
public class SecurityFilter {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, AccessDeniedHandler accessDeniedHandler){
